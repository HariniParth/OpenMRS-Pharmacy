    ...
    <table id="currentDrugOrdersTable">
        ...
        <tbody>
            <% currentDrugOrdersExtension.each { currentDrugOrderExtension -> %>
                <% if(currentDrugOrderExtension.orderId.equals(currentDrugOrdersMain.get(currentDrugOrderExtension.orderId).orderId) && ((currentDrugOrderExtension.orderstatus).equals("Active") || (currentDrugOrderExtension.orderstatus).equals("Hold"))) { %>
